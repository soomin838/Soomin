...
class SettingsDialog(QDialog):
    ...
    def _build_advanced_tab(self) -> None:
        ...
        self.news_ingestion_provider = QLabel("GDELT 공개 수집기")
        self.news_ingestion_provider.setObjectName("Subtitle")
        self.news_ingestion_note = QLabel("API 키 없이 GDELT 공개 뉴스 수집을 사용합니다.")
        self.news_ingestion_note.setWordWrap(True)
        self.news_ingestion_note.setObjectName("Subtitle")
        ...
        form.addRow("뉴스 수집 공급자", self.news_ingestion_provider)
        form.addRow("", self.news_ingestion_note)
    ...
    def save(self) -> None:
        ...
        _nested_set(self.data, "worldmonitor.enabled", False)
        _nested_set(self.data, "worldmonitor.api_key", "")
        _nested_set(self.data, "worldmonitor.prefer_api", False)
